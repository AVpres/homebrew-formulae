...
- the **openLTFS** package includes the _libltfs_ C library and its associated _ltfs_, _ltfsck_, _ltfscp_ and_ _mkltfs_ utilities, as well as the _openltfs_ Bash command-line interface;
